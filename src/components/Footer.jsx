                ...
                <div className='my-5 grid gap-2 md:grid-cols-4 sm:grid-cols-3'>
                    ...
                    <div>
                        <ul className='font-semibold mb-2 text-gray-200'>
                            ...
                            <li>
                                <a href='/marques'
                                   className='hover:text-green-hover '>
                                    <Link to="/marques">
                                        Marques
                                    </Link>
                                </a>
                    ...
                    <h2 className='text-lg font-semibold'>Newsletter</h2>
                        <div>
                            <input className='py-1 outline-none text-black text-sm rounded-lg indent-3 my-2 bg-gray-600' type="email" placeholder='E-mail' />
                        </div>
                        <div>
                            <button className='text-xs px-3 py-1 bg-slate-700 rounded-lg'>Être tenu informé</button>
                        </div>
                    </div>
